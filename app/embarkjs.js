...
const EmbarkJS = require("../embarkArtifacts/modules/embarkjs").default;
export default EmbarkJS;
global.EmbarkJS = EmbarkJS;

const Web3 = global.__Web3 || require('../embarkArtifacts/modules/web3');
...
if (!global.__Web3) {
    const web3ConnectionConfig = require('../embarkArtifacts/config/blockchain.json');
